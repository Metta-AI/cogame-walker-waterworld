...
# Substitute: walker-waterworld, coworld-walker-waterworld, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-walker-waterworld:ci)
#   SMOKE_SLUG                 game slug                        (walker-waterworld)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/walker-waterworld)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/walker-waterworld-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-walker-waterworld:ci}}"
slug="${SMOKE_SLUG:-walker-waterworld}"
