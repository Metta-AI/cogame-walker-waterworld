...
# use-after-free fixed in waterworld_replay.nim (emscripten_exit_with_live_runtime)
...
# waterworld_error_len(). Aborting keeps linear memory intact, and the page reads
# waterworld_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "waterworld_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_waterworld_load_replay,_waterworld_frame,_waterworld_input,_waterworld_packet_ptr,_waterworld_packet_len,_waterworld_mismatch_tick,_waterworld_error_ptr,_waterworld_error_len,_waterworld_stage_ptr,_waterworld_stage_len
  """).replace("\n", " ")
)
